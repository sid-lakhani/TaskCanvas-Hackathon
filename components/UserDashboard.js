    ...
    <div className="w-full max-w-[65ch] text-xs sm:text-sm mx-auto flex flex-1 flex-col gap-3 sm:gap-5">
      <div className="flex items-stretch">
        ...
        <button
          ...
          className="w-fit px-4 sm:px-6 py-2 sm:py-3 bg-red-500 text-white font-semibold text-base duration-700 hover:bg-red-600"
        >
          ADD
        </button>
      </div>
      <button
        ...
        className="px-4 sm:px-6 py-2 sm:py-3 text-white bg-red-500 font-semibold text-base duration-700 hover:bg-red-600"
      >
