        ...
        <div className='fixed inset-0 flex items-center justify-center bg-inherit overflow-hidden'>
            <div className='flex-1 flex flex-col text-xm sm:text-sm justify-center items-center gap-1 p-4'>
                ...
                <input
                    ...
                    autoComplete='email'
                    className='outline-none duration-300 border-b-2 border-solid border-white focus:border-cyan-300 text-slate-900 select-none p-2 w-full max-w-[40ch] hover:font-bold' />
                <input
                    value={password}
                    id='password'
                ...
                {!isLoggingIn && <input
                    ...
                    onKeyDown={handleKeyDown}
                    className={`outline-none duration-300 border-b-2 border-solid ${confirmPassword !== password ? 'border-red-500' : 'border-white focus:border-cyan-300 hover:font-bold'
